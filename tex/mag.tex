...
\lstset{language=C++, caption="TODO", captionpos=b, tabsize=3, frame=lines, keywordstyle=\color{blue}, commentstyle=\color{OliveGreen}, stringstyle=\color{red}, numbers=left, numberstyle=\small,numbersep=5pt, breaklines=true, showstringspaces=false, basicstyle=\footnotesize, emph={label}}
...
Przykłady użycia obu makr znajdują się w rozdziale poświęconym asercją (TODO numer rozdziału asercje).
...
Biblioteka Boost unittest w domyślnej konfiguracji nie wyświetla żadnych informacji w sytuacji kiedy testy kończą się powodzeniem, natomiast w przypadku błędu wyświetla komunikat zbliżony do informacji kompilatora w momencie znalezienia błędu w kodzie.
